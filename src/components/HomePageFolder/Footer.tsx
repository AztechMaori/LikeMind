...
export default function Footer() {
  return (
    <div class="row-span-1 bg-black text-white flex justify-evenly  h-20">
      <button class="font-bold text-lg border rounded-full w-20 h-10 pr-2 pl-2 min-h-fit min-w-fit mt-5 hover:text-emerald-500 duration-300"> Trending </button>
